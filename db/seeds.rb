...
User.create!({ email: "dan@example.com", first_name: "Dan", last_name: "Blair" })
User.create!({ email: "bob@example.com", first_name: "Bob", last_name: "Currie" })
User.create!({ email: "moira@example.com", first_name: "Moira", last_name: "Rose" })
User.create!({ email: "johnny@example.com", first_name: "Johnny", last_name: "Sprockets" })
