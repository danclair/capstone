...
Vehicle.create!({ nickname: "Duke Silver", make_id: 1, vehicle_model_id: 1, year: "2019", owner: true, color: "Midnight Silver", trim_id: 1, user_id: 1, image: "https://onlyusedtesla.com/wp-content/uploads/2017/02/profile-1-1024x768.jpeg" })
Vehicle.create!({ nickname: "Sparky", make_id: 1, vehicle_model_id: 2, year: "2018", owner: true, color: "Pearl White", trim_id: 4, user_id: 3, image: "https://onlyusedtesla.com/wp-content/uploads/2018/11/Tesla-Model-00020-1024x768.jpeg" })
Vehicle.create!({ nickname: "Apollo", make_id: 2, vehicle_model_id: 4, year: "2017", owner: true, color: "Electric Blue", trim_id: 5, user_id: 2, image: "https://blog.consumerguide.com/wp-content/uploads/sites/2/2017/11/Screen-Shot-2017-11-21-at-11.20.22-AM-1024x592.png" })
Vehicle.create!({ nickname: "Leafy", make_id: 3, vehicle_model_id: 5, year: "2020", owner: false, color: "Cherry Red", trim_id: 8, user_id: 4, image: "https://carsguide-res.cloudinary.com/image/upload/f_auto,fl_lossy,q_auto,t_cg__marking_background__sm_/v1/editorial/2020-Nissan-leaf-red-1200x800p%20%282%29.jpg" })
